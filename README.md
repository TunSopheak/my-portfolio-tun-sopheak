...
It features a sleek glassmorphism UI, a fully functional contact form with EmailJS integration, dynamic project routing, and an automatic dark/light mode toggle.
...
- **Dark/Light Mode** – Toggleable theme that persists via localStorage and detects the user's system preference.
...
├── data/                # Data files (projects.js, activities.js, achievements.js)
...
- **LinkedIn:** [linkedin.com/in/tun-sopheak](https://linkedin.com/in/tun-sopheak)
- **Telegram:** [t.me/TUN_SOPHEAK](https://t.me/TUN_SOPHEAK)
- **Facebook:** [facebook.com/Mr.TunSopheak](https://facebook.com/Mr.TunSopheak)
